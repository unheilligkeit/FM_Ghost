...
drohne = compile preprocessFile "scripts\drohne.sqf";
...
werbung1 setObjectTextureGlobal [0, "img\werbung1.paa"];
werbung2 setObjectTextureGlobal [0, "img\werbung2.paa"];
werbung3 setObjectTextureGlobal [0, "img\werbung2.paa"];
