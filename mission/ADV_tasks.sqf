	...
	default {
		[
			{true},
				[
					"task_1", 							//TaskName.
					"Nach dem absprung aus 15000 Meter höhe werdert ihr bei LZ Texas landen dannach sollen der Cia Aussenposten ereichen werden.", 					//Task Long Description - en detail.
					"Zum CiA Aussenposten gelangen.",					//Task Short Description - Titel der Aufgabe.
